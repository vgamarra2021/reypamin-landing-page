...
const products: IProduct[] = [
  {
    id: "especialistas-transmision-control-potencia",
  ...
  {
    id: "fabricacion-tableros-electricos",
  ...
  {
    id: "asientos-maquinaria-pesada-liviana",
  ...
  {
    id: "o-ring-sellos-hidraulicos-neumaticos",
